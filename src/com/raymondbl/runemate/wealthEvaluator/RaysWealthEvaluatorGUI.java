...
public final class RaysWealthEvaluatorGUI extends GUI {
    ...
    public void setCount(Integer count, Type type) {
        switch (type) {
            case TOTAL:
                this.totalCount.setText(count.toString());
                break;
            case BANK:
                this.bankCount.setText(count.toString());
                break;
            case INVEN:
                this.invCount.setText(count.toString());
                break;
        }
    }
    ...
    public void setWealth(Integer wealth, Type type) {
        switch (type) {
            case TOTAL:
                this.totalWealth.setText(wealth.toString() + " gp");
                break;
            case BANK:
                this.bankWealth.setText(wealth.toString() + " gp");
                break;
            case INVEN:
                this.invWealth.setText(wealth.toString() + " gp");
                break;
        }
    }
