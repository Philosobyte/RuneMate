...
public class Pouch {
	...
	public Pouch(int id)
	{
		...
		switch(id)
		{
		case 5509	:	capacity = 3;
						name = "Small pouch";
						degradedVariant = this;
						break;
		case 5510	:	capacity = 6;
						name = "Medium pouch";
						degradedVariant = new Pouch(5511);
						break;
		case 5512	:	capacity = 9;
						name = "Large pouch";
						degradedVariant = new Pouch(5513);
						break;
		case 5514	:	capacity = 12;
						name = "Giant pouch";
						degradedVariant = new Pouch(5515);
						break;
		case 24204	:	capacity = 18;
						name = "Massive pouch";
						degradedVariant = new Pouch(24205);
						break;
		case 5511	:	capacity = 5;
						name = "Medium pouch";
						degradedVariant = this;
						break;
		case 5513	:	capacity = 7;
						name = "Large pouch";
						degradedVariant = this;
						break;
		case 5515	:	capacity = 8;
						name = "Giant pouch";
						degradedVariant = this;
						break;
		case 24205	:	capacity = 18;
						name = "Massive pouch";
						degradedVariant = this;
						break;
		}
